 ...
 *  USA
 *
 *  $Id: s_err.c 985 2007-02-04 20:51:36Z shadowmaster $
 *
 */
...
static char *replies[] = {
  /* 000 */ NULL,
  /* 001 RPL_WELCOME */ ":%s 001 %s :Welcome to the %s network %s!%s@%s",
  /* 002 RPL_YOURHOST */
  ":%s 002 %s :Your host is %s, running %s",
  /* 003 RPL_CREATED */
  ":%s 003 %s :This server was last (re)started on %s and is located %s",
...
# ifdef HIGHEST_CONNECTION
  ...
  /* 404 ERR_CANNOTSENDTOCHAN */ ":%s 404 %s %s :Cannot send to channel (%s)",
  ...
  ":%s 440 %s %s :Services is currently down. Please wait a few moments, and then try again.",
  ...
  ":%s 477 %s %s :Cannot join channel, channel allows registered nicknames only (+R)",
  ...
  ":%s 481 %s :Permission denied, you do not have the correct irc operator privileges",
  ...
  /* 487 ERR_NONONREG */
  ":%s 487 %s :You must identify to a registered nick to private message %s",
  /* 488 ERR_NOTSSLCLIENT */
  ":%s 488 %s %s :Permission denied, target client is not a secure client (SSL enabled)",
  /* 489 */ NULL,
  /* In use by Undernet */
  /* 490 */ NULL,
